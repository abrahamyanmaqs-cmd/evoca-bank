...
const phoneCategories = [
  {
    ...
    path: "landline",
    image: "https://resource.evoca.am/images/WebPayment/beeline.png", // կարող ես փոխել հղումը ըստ քո ցանկության
  },
  {
    id: 2,
    title: "Ղարաբաղ Տելեկոմ ֆիքսված հեռախոսակապ",
    path: "karabakh-telecom-landline",
    image: "https://resource.evoca.am/images/webPayment/karabakh.png",
  },
];

export default function UtilityPhoneSubCategories() {
      ...
      <div className="max-w-[1200px] mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 justify-center max-w-[800px] mx-auto">
          {phoneCategories.map((item) => (
            <div
              key={item.id}
              onClick={() => navigate(`/payments/utility/phone/${item.path}`)}
