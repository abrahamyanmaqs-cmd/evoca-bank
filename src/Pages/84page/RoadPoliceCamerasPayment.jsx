...
export default function RoadPoliceCamerasPayment() {
  const [decisionNumber, setDecisionNumber] = useState('');
  const navigate = useNavigate();

  const handleContinue = (e) => {
    e.preventDefault();
    console.log("Որոշման համար:", decisionNumber);
  ...
  return (
    <div className="w-full bg-[#F8F9FA] font-sans min-h-screen py-12 md:py-20 flex flex-col items-center">
      <div className="max-w-[1200px] w-full mx-auto px-4 md:px-6">
        ...
        {/* Գլխավոր Վերնագիր */}
        <h1 className="text-[32px] md:text-[42px] font-bold text-[#1C1C1E] text-center mb-10 tracking-tight leading-tight">
          Արագաչափեր և<br />տեսախցիկներ
        </h1>
