    ...
    <div className="max-w-[1440px] mx-auto px-4 md:px-10 py-8">
      ...
      <div className="bg-[#EDF1F5] p-6 rounded-3xl shadow-sm">
        <div className="flex items-center justify-between overflow-x-auto pb-2 scrollbar-none">
          ...
          {/* «Արխիվ» կոճակը աջ մասում */}
          <button className="px-6 py-3 rounded-full text-[15px] font-semibold whitespace-nowrap transition-colors duration-200 outline-none cursor-pointer flex-shrink-0 bg-white text-[#5E1EEB] hover:bg-gray-50 flex items-center gap-2 shadow-sm ml-4">
            <span>Արխիվ</span>
