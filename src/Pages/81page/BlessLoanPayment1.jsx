...
export default function BlessLoanPayment1() {
    ...
    <div className="w-full bg-[#F8F9FA] font-sans min-h-screen py-12 md:py-20 flex flex-col items-center">
      <div className="max-w-[800px] w-full mx-auto px-4 md:px-6">
        ...
        <p className="text-[#6C757D] text-[14px] md:text-[15px] leading-relaxed text-center mb-10 px-2">
          Եթե Ձեր կատարած վճարումը գերազանցում է սույն<br/> վարկի հերթական մարման գումարի չափը, ապա<br/> գերազանցող մասը համարվելու է պարտավորության<br/> ժամկետից շուտ կատարվող և ուղղվելու է սույն վարկի<br/> մայր գումարի մարմանը: Փոփոխված<br /> ժամանակացույցը կարող եք ստանալ «Պրեմիում Կրեդիտ»<br/> ՈՒՎԿ-ի գլխավորային գրասենյակում կամ<br/> մասնաճյուղերում: Ոչ աշխատանքային օրը<br/> կատարված վճարումը կհամարվի մարում հաջորդ<br/> աշխատանքային օրը։
        </p>
