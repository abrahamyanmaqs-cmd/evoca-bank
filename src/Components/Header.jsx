...
const Header = () => {
  ...
  return (
    <div className="w-full border-b border-gray-200 bg-white">
      <div className="relative mx-auto flex items-center justify-between w-full max-w-[1440px] px-10">
        ...
        <div className="flex items-center gap-6 text-[13px] whitespace-nowrap">
          {tabs.map((tab) => (
            <p
              ...
              className={`cursor-pointer py-4 border-t-[3px] transition-all duration-200 -mt-[1px] ${
                activeTab === tab.name
        ...
        <div className="flex items-center w-auto justify-end gap-8 whitespace-nowrap ml-auto py-4">
          <div className="flex items-center gap-6">
            <div className="flex items-center gap-1 cursor-pointer group">
              <p className="text-[13px] font-medium text-[rgb(100,0,220)] font-['Montserratarm-Medium',Helvetica,Arial,sans-serif]">
                Առցանց հայտեր
              </p>
              <svg
                className="w-3 h-3 stroke-[rgb(100,0,220)] mt-[1px]"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
          ...
          <div className="flex items-center gap-4 text-gray-900">
            <svg
              className="w-[18px] h-[18px] cursor-pointer hover:text-[rgb(100,0,220)] transition-colors"
              fill="currentColor"
              viewBox="0 0 640 640"
            >
