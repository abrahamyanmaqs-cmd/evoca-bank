...
export default function VaultsTable2() {
  return (
    <section className="py-12 px-4 md:px-0 bg-white">
      <div className="max-w-[1200px] mx-auto">
        ...
        <h2 className="text-[24px] md:text-[28px] font-bold text-[#222222] mb-8">
          Չհրդեհվող անհատական պահարանների վարձակալում օտարերկրյա քաղաքացիների համար
        </h2>

        {/* Աղյուսակի կոնտեյներ (responsive սքրոլով) */}
        <div className="overflow-x-auto border border-[#E5E2EC] rounded-2xl shadow-sm mb-6">
          <table className="w-full text-left border-collapse bg-white">
            ...
            <tbody className="text-[15px] md:text-[17px] text-[#222222]">
              ...
              <tr className="border-b border-[#E5E2EC] hover:bg-[#F9F8FC] transition-colors">
                ...
                <td className="p-4 md:p-5 text-center border-r border-[#E5E2EC]">25,000 ՀՀ դրամ</td>
                <td className="p-4 md:p-5 text-center border-r border-[#E5E2EC]">35,000 ՀՀ դրամ</td>
              ...
              <tr className="border-b border-[#E5E2EC] hover:bg-[#F9F8FC] transition-colors">
                ...
                <td className="p-4 md:p-5 text-center border-r border-[#E5E2EC]">35,000 ՀՀ դրամ</td>
                <td className="p-4 md:p-5 text-center border-r border-[#E5E2EC]">50,000 ՀՀ դրամ</td>
                <td className="p-4 md:p-5 text-center">60,000 ՀՀ դրամ</td>
              </tr>

              <tr className="border-b border-[#E5E2EC] hover:bg-[#F9F8FC] transition-colors">
                <td className="p-4 md:p-5 font-medium border-r border-[#E5E2EC]">3 ամիս</td>
                <td className="p-4 md:p-5 text-center border-r border-[#E5E2EC]">50,000 ՀՀ դրամ</td>
                <td className="p-4 md:p-5 text-center border-r border-[#E5E2EC]">75,000 ՀՀ դրամ</td>
                <td className="p-4 md:p-5 text-center">100,000 ՀՀ դրամ</td>
              </tr>

              <tr className="border-b border-[#E5E2EC] hover:bg-[#F9F8FC] transition-colors">
                <td className="p-4 md:p-5 font-medium border-r border-[#E5E2EC]">6 ամիս</td>
                <td className="p-4 md:p-5 text-center border-r border-[#E5E2EC]">75,000 ՀՀ դրամ</td>
                <td className="p-4 md:p-5 text-center border-r border-[#E5E2EC]">100,000 ՀՀ դրամ</td>
                <td className="p-4 md:p-5 text-center">125,000 ՀՀ դրամ</td>
              </tr>

              <tr className="border-b border-[#E5E2EC] hover:bg-[#F9F8FC] transition-colors">
                <td className="p-4 md:p-5 font-medium border-r border-[#E5E2EC]">12 ամիս</td>
                <td className="p-4 md:p-5 text-center border-r border-[#E5E2EC]">100,000 ՀՀ դրամ</td>
                <td className="p-4 md:p-5 text-center border-r border-[#E5E2EC]">125,000 ՀՀ դրամ</td>
                <td className="p-4 md:p-5 text-center">150,000 ՀՀ դրամ</td>
              </tr>
        ...
        {/* Նշում */}
        <div className="text-[15px] md:text-[16px] text-[#222222]">
          <span className="font-bold">Նշում</span> - Միջնորդավճարները ներկայացված են ներառյալ ԱԱՀ:
        </div>
